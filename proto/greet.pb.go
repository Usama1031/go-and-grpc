...
const file_proto_greet_proto_rawDesc = "" +
	...
	"\amessage\x18\x01 \x03(\tR\amessage2\xe4\x02\n" +
	"\fGreetService\x12@\n" +
	"\bSayHello\x12\x16.greet_service.NoParam\x1a\x1c.greet_service.HelloResponse\x12V\n" +
	"\x1bSayHelloServerSideStreaming\x12\x17.greet_service.NameList\x1a\x1c.greet_service.HelloResponse0\x01\x12Y\n" +
	"\x1bSayHelloClientSideStreaming\x12\x1b.greet_service.HelloRequest\x1a\x1b.greet_service.MessagesList(\x01\x12_\n" +
...
var file_proto_greet_proto_depIdxs = []int32{
	...
	4, // 6: greet_service.GreetService.SayHelloClientSideStreaming:output_type -> greet_service.MessagesList
