...
type GreetServiceClient interface {
	...
	SayHelloClientSideStreaming(ctx context.Context, opts ...grpc.CallOption) (grpc.ClientStreamingClient[HelloRequest, MessagesList], error)
...
func (c *greetServiceClient) SayHelloClientSideStreaming(ctx context.Context, opts ...grpc.CallOption) (grpc.ClientStreamingClient[HelloRequest, MessagesList], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type GreetService_SayHelloClientSideStreamingClient = grpc.ClientStreamingClient[HelloRequest, MessagesList]
...
type GreetServiceServer interface {
	...
	SayHelloClientSideStreaming(grpc.ClientStreamingServer[HelloRequest, MessagesList]) error
...
func (UnimplementedGreetServiceServer) SayHelloClientSideStreaming(grpc.ClientStreamingServer[HelloRequest, MessagesList]) error {
...
func _GreetService_SayHelloClientSideStreaming_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(GreetServiceServer).SayHelloClientSideStreaming(&grpc.GenericServerStream[HelloRequest, MessagesList]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type GreetService_SayHelloClientSideStreamingServer = grpc.ClientStreamingServer[HelloRequest, MessagesList]
